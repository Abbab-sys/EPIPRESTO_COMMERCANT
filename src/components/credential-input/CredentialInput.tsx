...
import { SIGN_UP_CATEGORY_BAKERY_KEY, SIGN_UP_CATEGORY_BUTCHER_KEY, SIGN_UP_CATEGORY_FISH_KEY, SIGN_UP_CATEGORY_FRUITS_KEY, SIGN_UP_CATEGORY_HEALTHY_KEY, SIGN_UP_CATEGORY_KETO_KEY, SIGN_UP_CATEGORY_NOT_FOUND_KEY, SIGN_UP_CATEGORY_OTHER_KEY, SIGN_UP_CATEGORY_PLACEHOLDER_KEY, SIGN_UP_CATEGORY_WORLD_KEY } from '../../translations/keys/SignUpTranslationKeys';
