 ...
 * Description: This component is used to change the language of the application.
 * Author: Zouhair Derouich, Alessandro van Reusel
 */
    ...
    <SafeAreaView>
      <View style={[TitleSyles.view, ChangeLanguageStyles.titleView]}>
        ...
        <Text style={TitleSyles.headline}>
          {translation(SETTINGS_LANGUAGE_TITLE_KEY)}
        </Text>
      </View>
      <View>
        {Languages.map((section, index) => (
          <View style={ChangeLanguageStyles.buttonView} key={index}>
            <TouchableOpacity
              style={[
                ChangeLanguageStyles.button,
                {
                  backgroundColor:
                    i18n.language === section.code ? 'green' : '#D9D9D9',
                },
              ]}
              activeOpacity={0.5}
              ...
              />
              <Text style={ChangeLanguageStyles.buttonTextStyle}>
